...
const App: React.FC = () => {
  ...
  /**
   * Đã cập nhật link dẫn trực tiếp đến file logom.jpg trên GitHub của bạn.
   * Cấu trúc: raw.githubusercontent.com/[Username]/[Repo]/[Branch]/[FileName]
   */
  const logoUrl = "https://raw.githubusercontent.com/ihanbot/Elite-NW-Flooring-Coming-soon/main/logom.jpg";
    ...
    <main className="min-h-screen w-full flex flex-col items-center justify-center relative overflow-hidden bg-[#f8fafc] px-4 py-6 md:py-16">
      ...
      <div className="z-20 w-full max-w-5xl text-center space-y-12 md:space-y-16 animate-fade-in">
        ...
        <div className="flex flex-col items-center w-full px-2">
          <div className="relative group w-full max-w-[720px] bg-white p-8 md:p-14 rounded-[2rem] md:rounded-[3rem] shadow-[0_20px_50px_-12px_rgba(29,59,100,0.12)] border border-white transition-all duration-700 hover:shadow-[0_40px_80px_-15px_rgba(29,59,100,0.2)] overflow-hidden min-h-[160px] md:min-h-[240px] flex items-center justify-center">
            ...
            {logoUrl ? (
              <img 
                ...
                className="w-full h-auto max-h-[180px] md:max-h-[260px] object-contain block mx-auto transition-transform duration-700 group-hover:scale-[1.02]"
                onError={(e) => {
                  // Fallback nếu link GitHub chưa sẵn sàng
                  e.currentTarget.style.display = 'none';
                  console.error("Logo not found at GitHub path");
                }}
              />
            ) : (
              <div className="flex flex-col items-center justify-center py-10 opacity-20">
                <p className="text-[10px] font-black uppercase tracking-[0.4em]">Logo Placeholder</p>
              </div>
            )}
          </div>
        </div>
